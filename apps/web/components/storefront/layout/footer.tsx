...
export function Footer() {
  return (
    <footer className="bg-surface border-t border-border px-4 md:px-6 lg:px-8 py-8">
      ...
      <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-border text-center">
